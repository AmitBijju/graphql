...
import (
	...
	"github.com/AmitBijju/graphql/internal/jsonutil"
...
func (c *Client) do(ctx context.Context, op operationType, v interface{}, variables map[string]interface{}, headers map[string]string) error {
	var query string
	switch op {
	case queryOperation:
